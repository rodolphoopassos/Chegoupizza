    ...
    <>
      ...
      >
        ...
        <div className="flex-1 py-8 px-4 space-y-2 overflow-y-auto custom-scrollbar">
          ...
          <SidebarLink active={activeTab === 'financeiro'} onClick={() => handleTabClick('financeiro')} icon={<Calculator size={20} />} label="Contas & Vencimentos" isOpen={isSidebarOpen} />
          ...
          <SidebarLink active={activeTab === 'logistics'} onClick={() => handleTabClick('logistics')} icon={<Truck size={20} />} label="Logística & Rotas" isOpen={isSidebarOpen} />
